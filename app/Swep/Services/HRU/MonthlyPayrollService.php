...
//                    $q->nonZero();
    ...
    public function alphalistGsisHdmf($payrollMasterSlug)
    {
        $request = Request::capture();
        $payrollMaster = PayrollMaster::query()
            ->with([
        ...
        return Pdf::view('printables.hru.payroll_preparation.MONTHLY.alphalist-gsis-hdmf',[
            'pdfPrint' => true,
            'payrollMaster' => $payrollMaster,
        ])
            ->paperSize('215.9','330.2')
        ...
        return view('printables.hru.payroll_preparation.MONTHLY.alphalist-gsis-hdmf')->with([
            'payrollMaster' => $payrollMaster,
        ]);
