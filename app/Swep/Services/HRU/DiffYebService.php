...
class DiffYebService
{
    ...
    public function edit($payrollMaster,$slug,$request)
    {
        ...
        return view('_payroll.payroll-preparation.DIFF-YEB.edit')->with([
    ...
    private function recompute($payrollMasterSlug,$payMasterEmployeeSlug = null,$avoid = [])
    {
        ...
        foreach ($payrollMaster->payrollMasterEmployees as $payrollMasterEmployee){
            $views[$payrollMasterEmployee->slug] = view('_payroll.payroll-preparation.DIFF-YEB.preview-row')->with([
                'payrollMaster' => $payrollMaster,
    ...
    public function printPayroll($payrollMasterSlug)
    {
        ...
        return Pdf::view('printables.hru.payroll_preparation.DIFF-YEB.payroll',[
            'pdfPrint' => true,
            'payrollMaster' => $payrollMaster,
            'tree' => $tree,
