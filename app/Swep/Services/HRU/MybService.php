...
class MybService
{
    ...
    public function recompute($payrollMasterSlug,$payMasterEmployeeSlug = null,$avoid = [])
    {
        ...
        PayrollMasterDetails::query()
            ->upsert(
                ...
                ['amount','priority','account_code','taxable']
            );
        //refresh
        ...
        foreach ($payrollMaster->payrollMasterEmployees as $payrollMasterEmployee){
                ...
                $taxable = $taxableAmount * 2 - $this->maxNonTax;
        ...
        if($payMasterEmployeeSlug != null){
            ...
            return view('_payroll.payroll-preparation.MYB.preview-row')->with([
        ...
        return view('_payroll.payroll-preparation.MYB.preview')->with([
    ...
    public function printPayroll($payrollMasterSlug)
    {
        ...
        return Pdf::view('printables.hru.payroll_preparation.MYB.payroll',[
                'pdfPrint' => true,
                'payrollMaster' => $payrollMaster,
                'tree' => $tree,
        ...
        /*
        return view('printables.hru.payroll_preparation.MYB.payroll')->with([
            'payrollMaster' => $payrollMaster,
            'tree' => $tree,
            'payrollEmployeesGroupedByRespCenter' => $payrollMaster->payrollMasterEmployees->groupBy(function ($data){
                return $data->employee->resp_center;
