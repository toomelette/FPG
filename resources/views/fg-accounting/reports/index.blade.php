        ...
        <div class="col-md-3 col-xl-2">
            ...
            <div class="card">
                <div class="list-group list-group-flush" role="tablist">
                    <a class="list-group-item list-group-item-action active" data-bs-toggle="list" href="#cash-receipts-register" role="tab" aria-selected="true">
                        Cash Receipts Register
                    </a>
                    <a class="list-group-item list-group-item-action" data-bs-toggle="list" href="#cash-disbursements-register" role="tab" aria-selected="false" tabindex="-1">
                        Cash Disbursements Register
                    </a>
                    <a class="list-group-item list-group-item-action" data-bs-toggle="list" href="#general-journal-register" role="tab" aria-selected="false" tabindex="-1">
                    ...
                    <a class="list-group-item list-group-item-action" data-bs-toggle="list" href="#analysis-of-accounts" role="tab" aria-selected="false" tabindex="-1">
