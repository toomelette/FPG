    ...
    <form id="edit-journal-form">
        <x-adminkit.html.card header-class="pt-3 pb-1" body-class="pt-2">
            ...
            <div class="row">
                    <div class="col-md-4">
                        <div class="row">
                            <x-forms.input label="OR No." name="control_no" cols="6" :value="$journal ?? null"/>
                            <x-forms.input label="Date" name="date" cols="6" type="date" :value="$journal ?? null"/>
                        </div>
                        <div class="row mt-2">
                            <x-forms.input label="Payor" name="counterparty" cols="12" :value="$journal ?? null"/>
                        </div>
                        <div class="row mt-2 mb-4">
                            <x-forms.textarea label="Remarks" name="remarks" cols="12" :value="$journal ?? null"/>
                        </div>
                        ...
                        <div class="row mt-2">
                            <x-forms.input label="Drawee Bank" name="bank" cols="6" :value="$journal ?? null"/>
