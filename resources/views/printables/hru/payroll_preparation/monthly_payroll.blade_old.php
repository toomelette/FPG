    ...
    <div style="break-after: page">
        <table style="width: 100%" class="">
            ...
            <tr>
                ...
                <th class="text-center">15th 30th</th>
                ...
                @foreach($tree as $dept)
                    @if(isset($usedRc[$dept->rc_code]))
                        @php
                            ...
                            $totals[$dept->rc_code]['pay15'] = null;
                            $totals[$dept->rc_code]['pay30'] = null;
                                            ...
                                            @switch($x)
                                                @case(0)
                                                    <td class="text-right">
                                                        ...
                                                        @php
                                                            $totals[$dept->rc_code]['pay15'] = $totals[$dept->rc_code]['pay15'] + $employee->pay15;
                                                        @endphp
                                                    </td>
                                                ...
                                                @case(1)
                                                    <td class="text-right">
                                                        ...
                                                        @php
                                                            $totals[$dept->rc_code]['pay30'] = $totals[$dept->rc_code]['pay30'] + $employee->pay30;
                                                        @endphp
                                                    </td>
                        ...
                        @if($dept->children->count() > 0)
                            @foreach($dept->children as $secondLevel)
                                @if(isset($usedRc[$secondLevel->rc_code]))
                                    @php
                                    ...
                                    @if($secondLevel->children->count() > 0)
                                        @foreach($secondLevel->children as $thirdLevel)
                                            @if(isset($usedRc[$thirdLevel->rc_code]))
                                                @php
                        ...
                        @for($x = 0; $x < $chunkBy ; $x++)
                            <tr>
                                ...
                                @switch($x)
                                    @case(0)
                                        <td class="text-right b-top">
                                            {{\App\Swep\Helpers\Helper::toNumber($totals[$dept->rc_code]['pay15'])}}
                                        </td>
                                        <td style="padding-left: 7px" class="b-top">15TH</td>
                                        <td class="b-top"></td>
                                        @break
                                    @case(1)
                                        <td class="text-right">
                                            {{\App\Swep\Helpers\Helper::toNumber($totals[$dept->rc_code]['pay30'])}}
                                        </td>
                                        <td style="padding-left: 7px">30TH</td>
                                        <td></td>
                                        @break
