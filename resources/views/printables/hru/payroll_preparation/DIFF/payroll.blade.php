        ...
        <div style="break-after: page">
            ...
            <table style="width: 100%" class=" tbl-padded">
                ...
                <tr>
                    ...
                    <th class="text-center">PERIOD <br> WKNG DAYS</th>
                        ...
                        @forelse($payrollEmployeesPerRc as $payrollEmployee /** @var App\Models\HRU\PayrollMasterEmployees $payrollEmployee **/)
                            <tr>
                                ...
                                <td class="text-center text-top">
                                    {{Helper::dateFormat($payrollEmployee->diff_from,'d')}} to {{Helper::dateFormat($payrollEmployee->diff_to,'d')}} <br>
                                    <small>{{$payrollEmployee->diff_days}}</small>
                                </td>
