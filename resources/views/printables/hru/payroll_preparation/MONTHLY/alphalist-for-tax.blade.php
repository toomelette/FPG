    ...
    <div style="font-family: Cambria, Caladea">
        <div style="break-after: page">
            ...
            <div style="text-align: left; margin-bottom: 20px">
                <h3 class="no-margin text-strong" style="font-size: 18px">Alphalist - 15th</h3>
            </div>
        ...
        <div style="break-after: page">
            ...
            <div style="text-align: left; margin-bottom: 20px">
                <h3 class="no-margin text-strong" style="font-size: 18px">Alphalist - 30th</h3>
            </div>
            ...
            <table style="width: 100%;" class="tbl-padded tbl-bordered-grey">
                ...
                @forelse($payrollMaster->payrollMasterEmployees as $payrollMasterEmployee)
                    <tr>
                        <td>{{$loop->iteration}}</td>
                        <td>{{$payrollMasterEmployee->saved_employee_data['full_name']}}</td>
                        <td class="text-right">{{Helper::toNumber($payrollMasterEmployee->pay30)}}</td>
                    </tr>
                @empty
                @endforelse
                <tr>
