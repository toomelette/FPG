        ...
        @forelse($groupedDeductions as $deductionCode => $deductions)
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td style="width: 38%;" class="text-strong">{{Carbon::parse($payrollMaster->date)->format('F Y')}}</td>
            ...
            @include('printables.hru.payroll_preparation.YEB.deduction-register-default')
