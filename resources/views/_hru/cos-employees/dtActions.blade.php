<div class="btn-group btn-group-sm">
    ...
    <button type="button" data="{{$cosEmployee->hr_cos_employees_slug}}" onclick="delete_data('{{$cosEmployee->slug}}','{{route('dashboard.cos_employees.destroy','slug')}}')" class="btn btn-sm btn-danger delete_jo_employee_btn">
