    ...
    <form id="edit-employee-form" autocomplete="off">
        <div class="tab mb-1">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item hide-this" role="presentation"><a class="nav-link" href="#tab-4" data-bs-toggle="tab" role="tab" aria-selected="false" tabindex="-1">Other Records</a></li>
                <li class="nav-item hide-this" role="presentation"><a class="nav-link" href="#tab-5" data-bs-toggle="tab" role="tab" aria-selected="false" tabindex="-1">Other Questions</a></li>
            </ul>
            ...
            <div class="tab-content">
                    <div class="tab-pane active show" id="tab-1" role="tabpanel">
                        ...
                        <div class="row mb-3">
                            ...
                            <x-forms.select label="Appt. Status" name="appointment_status" cols="2"  :options="\App\Swep\Helpers\Helper::populateOptionsFromObjectAsArray(\App\Models\SuOptions::employeeApptStatus(),'option','value')" :value="$employee ?? null"/>
                            <x-forms.select label="Status" name="is_active" cols="2" id="is_active"  :options="\App\Swep\Helpers\Helper::populateOptionsFromObjectAsArray(\App\Models\SuOptions::employeeStatus(),'value','option')" :value="$employee ?? null"/>
                        </div>
