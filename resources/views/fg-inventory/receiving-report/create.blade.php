...
@section('content2')
    <x-adminkit.html.page-title>
        <x-slot:title>New Receiving Report</x-slot:title>
    </x-adminkit.html.page-title>

    <form id="add-receiving-report-form">
        <x-adminkit.html.card header-class="pt-3 pb-1" body-class="pt-2">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="row">
                        <x-forms.input label="RR No." name="control_no" cols="6"/>
                    ...
                    <div class="row mt-2">
                        ...
                        <x-forms.input label="Inv/DR No" name="inv_dr_no" cols="6"/>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row mt-2">
                        <x-forms.input label="Total" name="total_amount_due" cols="4" class="autonum-total-amount-due text-end" readonly="readonly"/>
                        <x-forms.input label="EWT" name="ewt" cols="4" class="autonum text-end" />
                        <x-forms.input label="A/P" name="ap" cols="4" class="autonum text-end"/>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $("#add-receiving-report-form").submit(function (e) {
            e.preventDefault()
            let form = $(this);
            loading_btn(form);
            $.ajax({
                url : '{{route("receiving-report.store")}}',
                data : form.serialize(),
                type: 'POST',
                headers: {
                    {!! __html::token_header() !!}
