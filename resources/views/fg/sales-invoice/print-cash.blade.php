        ...
        <table style="width: 100%; font-size: 14px" id="details-tbl" class="">
            @forelse($salesInvoice->details as $detail)
                <tr class="details-row">
                    <td style="width: 22mm;" class="text-center text-top">{{$detail->qty}}</td>
                    <td style="width: 17mm;" class="text-center text-top">{{$detail->uom}}</td>
                    <td style="width: 80mm;" class="text-top">{{$detail->description}}</td>
                    <td style="width: 27mm; padding-bottom: 8mm" class="text-right text-top">{{Helper::toNumber($detail->unit_cost)}}</td>
