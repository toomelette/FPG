                ...
                <div class="tab-pane fade show active" id="cash-receipts-register" role="tabpanel">
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            <form class="report-form" target="{{route('cash-advances.reports')}}?generate&report_type=summary">
                                <div class="row mb-2">
                                    <x-forms.select :options="\App\Swep\Helpers\Arrays::projectIds()" label="Branch" name="project_id" cols="2" />
                                    <x-forms.select :options="\App\Swep\Helpers\Arrays::cashAdvanceTypes()" label="Type" name="type" cols="2" />
