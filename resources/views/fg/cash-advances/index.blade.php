...
@section('content2')
    <x-adminkit.html.page-title>
        <x-slot:title>Cash Advances</x-slot:title>
    </x-adminkit.html.page-title>
...
@section('modals')
    ...
    <x-adminkit.html.modal id="make-action-cash-advance-modal" size="sm"/>
@endsection
...
@section('scripts')
    <script type="text/javascript">
        ...
        $("body").on("click",".make-action-cash-advance-btn",function () {
            let btn = $(this);
            load_modal2(btn);
            let uri = '{{route("cash-advances.edit","slug")}}?makeAction';
