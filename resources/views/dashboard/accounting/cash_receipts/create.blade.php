            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        {!! \App\Swep\ViewHelpers\__form2::select('funds_source',[
                            'label' => 'Fund Source:',
                            'cols' => 2,
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab">JEV Details</a></li>
                            <li><a href="#tab_2" data-toggle="tab">Corollary Accounts</a></li>
                        </ul>
                            ...
                            <div class="tab-pane" id="tab_2">
                                <table id="corollary_accounts_table" class="table table-condensed table-bordered table-striped">
                                    ...
                                    <tr class="bg-info">
                                        ...
                                        <th style="width: 10%;">Credit</th>
                                        <th style="width: 60px">
                                            <button type="button" id="add_corollary_account_btn" class="btn btn-success btn-xs add_btn"><i class="fa fa-plus"></i> Add</button>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
