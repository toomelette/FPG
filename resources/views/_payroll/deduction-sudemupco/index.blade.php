                    ...
                    @foreach($monthsArray as $year => $months)
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="acc-{{$year}}">
                                ...
                                @else
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#acc-body-2026" aria-expanded="false" aria-controls="filter-accordion">
                                        2026
                                    </button>
                                @endif
                            </h2>
