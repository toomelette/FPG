...
@section('content2')
    <x-adminkit.html.page-title>
        <x-slot:title>MYB (Mid-year Bonus)</x-slot:title>
    ...
    <x-adminkit.html.card body-class="pt-0">
        ...
        <div class="box-body" id="payroll-table">
            @include('_payroll.payroll-preparation.MYB.preview',[
...
@section('modals')
    ...
    <x-adminkit.html.offcanvas class="end" id="print-offcanvas">
        ...
        <a href="{{route('dashboard.payroll_preparation.print',[$payrollMaster->slug,'MYB'])}}" target="_blank" class="btn btn-outline-primary btn-sm col-12 mb-2 require-dialog"> <i class="fa fa-print"></i> Payroll Summary</a>
