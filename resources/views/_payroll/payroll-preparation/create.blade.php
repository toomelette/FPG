...
@section('scripts')
    <script type="text/javascript">
        ...
        $("body").on('change','#filter-by-payroll-group-select',function (){
            filterByPayrollGroup();
        });

        function filterByPayrollGroup() {
            var input, filter, table, tr, td, i, txtValue;
            input = document.getElementById("filter-by-payroll-group-select");
            filter = input.value.toUpperCase();
            table = document.getElementById("employees-table");
            tr = table.getElementsByTagName("tr");
            for (i = 0; i < tr.length; i++) {
