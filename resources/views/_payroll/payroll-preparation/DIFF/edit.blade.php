...
@section('modals')
    ...
    <x-adminkit.html.offcanvas class="end" id="print-offcanvas">
        ...
        <a href="{{route('dashboard.payroll_preparation.print',[$payrollMaster->slug,'DIFF'])}}" target="_blank" class="btn btn-outline-primary btn-sm col-12 mb-2 require-dialog"> <i class="fa fa-print"></i> Payroll Summary</a>
