...
//    Route::resource('publication_applicants/{publication_detail_slug}');
    ...
    /** Payroll Preparation **/
    Route::get('/payroll_preparation/reports',\App\Http\Controllers\HRU\PayrollPreparationController::class.'@reports')->name('payroll_preparation.reports');
    ...
    Route::get('cos_employees/{slug}/create',[\App\Http\Controllers\HRU\COSEmployeesController::class,'create'])->name('cos_employees.create');
...
Route::get('acro',function (){
    return view('printables.hru.certificate-of-appearance.FM-AFD-ACC-002,01');
});